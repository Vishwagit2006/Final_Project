...
const BussinessBottomNav = () => {
  ...
  const navItems = [
    { route: '/Screens/Business/Home', icon: 'home', label: 'Home' },
    { route: '/Screens/Business/Request', icon: 'clipboard-check', label: 'Request' },
    { route: '/Screens/Business/BusinessProvideGoods', icon: 'hand-coin', label: '', isCenter: true },
    { route: '/shared/CommunityScreen', icon: 'account-group', label: 'Communites' },
    { route: '/Screens/Business/Profiles', icon: 'account', label: 'Profile' },
  ];
